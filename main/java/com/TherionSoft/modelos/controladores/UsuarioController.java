package com.TherionSoft.modelos.controladores;
...
public class UsuarioController {
	...
	@PostMapping("/login")
	public ResponseEntity<?> login(@Valid @RequestBody UsuarioLoginDTO usuarioLogin, BindingResult bindingResult) throws Exception {
		...
		return new ResponseEntity<RespuestaDTO>(usuarioService.login(usuarioLogin), HttpStatus.OK);
